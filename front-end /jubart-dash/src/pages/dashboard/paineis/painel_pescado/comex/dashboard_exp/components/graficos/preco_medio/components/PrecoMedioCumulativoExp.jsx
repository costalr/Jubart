...
const PrecoMedioCumulativoExp = ({ startYear, endYear, startMonth, endMonth, exportData }) => {
  ...
  const downloadChart = () => {
    if (chartRef.current) {
      ...
      clonedCtx.fillText('Preço Médio Cumulativo de Exportação', clonedCanvas.width / 2, 30);
      ...
      link.download = 'PrecoMedioCumulativoExportacao.png';
      link.click();
    }
  };
  ...
  return (
    <div>
      <h2>Preço Médio Cumulativo de Exportação</h2>
...
export default PrecoMedioCumulativoExp;
