...
function GraficosPaisesDecisaoExp({ exportData, startYear, endYear, startMonth, endMonth }) {
  return (
    <div className="graficos-paises-exp decisao">
      <ReducaoPrecoMedio
...
export default GraficosPaisesDecisaoExp;
